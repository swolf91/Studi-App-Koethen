...
public class ExpandableListViewAdapter extends BaseExpandableListAdapter {
	...
	/**
	 * L�dt alle Gebaeude, nach Kategorie geordnet, in die ExpandableList
	 * @param newcontext
	 */
	//TODO Baustelle.................
	public ExpandableListViewAdapter(Context newcontext){
		 ...
		 buildingList=bmanager.getInstance().getBuildingList(bc.getInstance().getBuildingCategories());

		 BuildingCategory []category = new BuildingCategory[size];
		 category=bc.getBuildingCategories();
